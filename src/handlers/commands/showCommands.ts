...
export async function handleShowCommands(replyToken: string) {
  const replyMessage = `🤖 รายการคำสั่ง
    \n👉แจ้งลา (ลาพักร้อน|ลาป่วย|ลากิจ) (01JAN|01JAN-02JAN) (1วัน|ครึ่งเช้า|ครึ่งบ่าย) (key|nokey) (เหตุผล)
    \n👉nc (อบรม|training|กิจกรรมบริษัท) (26JAN|26JAN-28JAN) (1วัน|ครึ่งเช้า|ครึ่งบ่าย) (เหตุผล)
    \n👉อัปเดต (id) (cer|nocer|key|nokey)
    \n👉hh ใช้ (1h|4h) (01JAN|01JAN-02JAN) (1วัน|ครึ่งเช้า|ครึ่งบ่าย) (เหตุผล)
